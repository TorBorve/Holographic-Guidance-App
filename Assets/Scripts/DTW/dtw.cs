...
namespace FastDtw.CSharp
{
    public static class Dtw
    {
        private static double GetScoreSlower(double[] arrayA, double[] arrayB)
        {
            ...
            var spanA = new ArraySegment<double>(arrayA);
            var spanB = new ArraySegment<double>(arrayB);
            ...
            for (var i = 1; i < aLength; i++)
            {
                ...
                {
                    var cost = Math.Abs(spanA.Array[spanA.Offset + i - 1] - spanB.Array[spanB.Offset + j - 1]);
        ...
        public static double GetScore(double[] arrayA, double[] arrayB)
        {
            ...
            for (var i = 1; i < aLength; i++)
            {
                ...
                for (var j = 1; j < bLength; j++)
                {
                    ...
                    dtw[currentRow + j] = Math.Abs(spanA.Array[spanA.Offset + i - 1] - spanB.Array[spanB.Offset + j - 1]) + lastMin;
                }
        ...
        public static float GetScoreF(float[] arrayA, float[] arrayB)
        {
            ...
            var spanA = new ArraySegment<float>(arrayA);
            var spanB = new ArraySegment<float>(arrayB);
